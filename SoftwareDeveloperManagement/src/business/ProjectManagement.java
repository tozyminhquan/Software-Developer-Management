...
public class ProjectManagement implements Workable<Project> {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                try {
                    ...
                    System.out.println("Error reading duration at line: " + line);
                    continue;
                }
    ...
    public List<Project> filterByDeveloperName(String devName) {
        ...
        for (Project p : projectList) {
            Developers dev = devManager.findById(p.getDevID());
            if (dev != null) {
    ...
    public void displayGroupedByDeveloper() {
        ...
        for (Project p : projectList) {
            if (!devIds.contains(p.getDevID().toUpperCase())) {
                devIds.add(p.getDevID().toUpperCase());
            }
        }

        for (String devId : devIds) {
            Developers dev = devManager.findById(devId);
    ...
    public void handleTotalExperience() {
        ...
        Developers targetDev = devManager.findById(expDevId);
        if (targetDev == null) {
